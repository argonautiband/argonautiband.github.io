...
$(function () {
    //$("#slides").superslides({ hashchange: !1, animation: "fade", play: 1e4 })
    var emlAddrss = "ar" + "gona" + "utiba" + "nd" + String.fromCharCode(64) + "gm" + "ail." + "co" + "m";
    $('.emailAnchor').attr("href", "mai" + "lt" + "o:" + emlAddrss);
    $('#emailSpan').text(emlAddrss);
    //$("ul.filters li:first").click();
    $(".thumbnails").isotope({ filter: '.live' })
});
var $actualnew= null;
var openednew=false;
...
/**/
var template_image = "<div class='thumbnail small ?'>" +
    "<a rel='?' href='#' class='swipebox'>" +
    "<img src='#' alt=''>" +
    "<div class='rollover'>" +
    "<i class='plus'></i>" +
    "</div></a></div >";

var template_song = '<li><span>?</span>&nbsp;&nbsp;&nbsp;<i class="fa fa-play" style="color: #ed2b45"></i></li>'

var base_image_path = '/images/argonauti/gallery/';

var images_stories = [
    '[2004] Argonauti live @ festa della donna Fratticciola.JPG',
    '[2005] Argonauti live @ Aliby.JPG',
    '[2005] Copertina CD.jpg',
    '[2006] Argonauti live @ Carnevale Moiano.JPG',
    '[2008] Argonauti live @ Route 66.JPG',
    '[2009] Argonauti Live @ Camucia - Dani.JPG',
    '[2009] Argonauti Live @ Camucia - Fabio.JPG',
    '[2009] Argonauti Live @ Camucia - Fede.JPG',
    '[2009] Argonauti Live @ Camucia - Gianlu.JPG',
    '[2009] Argonauti Live @ Camucia - Luca.JPG',
    '[2009] Argonauti Live @ Camucia - Marco.JPG',
    '[2009] Argonauti Live @ Camucia.JPG',
    '[2013] Argonauti Live @ Club 84 (Halloween).JPG',
    '[2014] Argonauti Live @ Buskers Ferrara - Arrivo.JPG',
    '[2014] Argonauti Live @ Buskers Ferrara - Pass.JPG',
    'Argonauti Live @ Buskers Ferrara.jpg',
    '223330_1079101067558_9496_n.jpg',
    '283994_2246813138817_4177420_n.jpg',
    '291184_2377221317704_1698684952_o.jpg',
    '308722_2296132277905_878966928_n.jpg',
    '322094_2377226637837_695750238_o.jpg',
    '340531_2377214437532_1087628785_o.jpg',
    '120876668020155.jpg',
    '136156919825463.jpg',
    'argo famiglia addams.jpg',
    'Foto Satomi.jpg',
    'IMG_3811.JPG',
    'IMG_3813.JPG'
];

var images_matrimoni = [
    '1016_Wedding Marco e Daniela_IMG_1394.jpg',
    '1087_Wedding Marco e Daniela_IMG_1423.jpg',
    '13344625_926841917427813_2197155600869056593_n.jpg',
    '13619840_946580075453997_1334660181460408572_n.jpg',
    '13654388_945754675536537_308023859981357941_n.jpg',
    '20160618_231152.jpg',
    'Argo matrimonio villa petrischio.jpg',
    'Argo matrimonio.jpg',
    'IMG-20160619-WA0006.jpg',
    'IMG-20161006-WA0004.jpg',
    'IMG-20170715-WA0061.jpg'
];

var images_locandine = [
    'Argo Simpson Logo.png',
    'Argonauti Carrello 2.JPG',
    'Argonauti_Locandina.png',
    'I Love Argonauti foonky 3.png',
    'IMG_1877.JPG',
    'IMG-20170429-WA0010.jpg',
    'IMG-20170930-WA0013-01.jpeg',
    'KeepCalmAndLoveArgonauti.PNG'
];

var images_live = [
    'DV 2012/298994986874988.jpg',
    'DV 2012/298994703541683.jpg',
    'DV 2012/298994486875038.jpg',
    'DV 2012/298994303541723.jpg',
    'DV 2012/298995180208302.jpg',
    '2014 Bierfest/[2014] BierFest.jpg',
    '2014 subway/545996995508118.jpg',
    '2014 subway/545997268841424.jpg',
    '2014 subway/545997732174711.jpg',
    '2014 subway/545997822174702.jpg',
    '2014 subway/545997965508021.jpg',
    '2014 subway/545997982174686.jpg',
    '2014 subway/i-phone 1 301.JPG'
];
...
$(document).ready(function () {
    ...
    for (index = 0; index < tmpArray.length; ++index) {
        $('#thumbnails').append(template_image.replace(/\?/g, tagName).replace(/\#/g, base_image_path + tagName + '/' + tmpArray[index]));
    }
