...
$(window).on("load", function () {
  ...
  // filter items on button click
    $('.filters').on('click', 'li', function () {
        $container.isotope({ filter: $('[data-filter]').first().attr('data-filter') }); //Workaround perch� altrimenti la sezione matrimoni spagina
...
$(function () {
    ...
    $('i.fa.fa-play').on("click", function () {
        audioPlay($(this));
    });
    //var aud = document.getElementById("audioplayer0");
...
function audioPlay(elem) {
    ...
    {
        var audioplayerid = elem.data("audioplayerid");
